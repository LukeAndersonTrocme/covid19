...
lr <-
  ...
  geom_vline(data = subset %>%
             ...
             aes(xintercept = date,
                 group = country_region, 
                 alpha = 2^-dt), linetype = 1, color = "tomato", size = 0.83) +
  geom_hline(yintercept = 7, linetype = 2, color = "grey50", size = 0.5) +
  geom_point(size = 0.2) +
...
plot_grid(cu,lr,mob,ncol=1, rel_heights = c(1,1,1.2), align = "v", axis = "b", labels = "AUTO")

ggsave(paste0(covidFigPath, "figure1.jpg"), height = 15, width = 25)
ggsave(paste0(covidFigPath, "figure1.pdf"), height = 15, width = 25)
```
...
spp<-
  ...
  scale_y_continuous(trans = reverselog_trans(2), 
                     breaks = c(2,4, 7,14,28, 56, 112, 224,365),
                     labels = c("2 days", "4 days", "1 week", "2 weeks", "1 month", "2 months", "4 months", "8 months","1 year"),
...
plot_grid(spp, dcc, nrow = 1, align = "h", axis = "l", rel_widths = c(1,1.3), labels = "AUTO")
