...
ontario_map <-
  ...
  geom_text_repel(data = loc_covid_on,
                  ...
                  segment.alpha = 0.3,
                  fontface= "bold") +
  scale_size_area(breaks = c(100,250,500),
                  max_size = 15,
                  name = "Count") +
  scale_color_distiller(palette = "RdYlGn",
                        ...
                        trans = "log10",
                        guide = FALSE) +
  labs(title = paste0("Cities with more than 50 cases")) +
  theme_classic() + 
...
outcomes <-
  ggplot(covid_on %>%
           filter(Age_Group != "Unknown") %>%
           mutate(Outcome = gsub("Yes","Recovered",RESOLVED),
                  Outcome = gsub("No","Infected",Outcome)),
         aes(x = Age_Group,
             fill = Outcome,
             group = Outcome)) +
