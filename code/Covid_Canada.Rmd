...
ishaberry_data_url <- "https://docs.google.com/spreadsheets/d/1D6okqtBS3S2NRC7GFVHzaZ67DuTw7LX49-fqSLwJyeo/export?format=csv"

# Download data
download.file(data_url, destfile = paste0(covidPath, "covid19.csv"), quiet = T)
download.file(ishabery_data_url, destfile = paste0(covidPath, "covid19_ishaberry.csv"), quiet = T)
...
covid_i <- 
  read.csv(paste0(covidPath, "covid19_ishaberry.csv"))
```
